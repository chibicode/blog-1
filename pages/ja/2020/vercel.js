...
export default withViews(({ views }) => (
  <Post>
    ...
    <P>
      まずは最近の大きな流れとして、クラウドインフラ、Kubernetes、様々なAPIを提供するサービス等の台頭により、バックエンド開発にコモディティ化の波が押し寄せました。その結果、やりがいがある革新の機会がどれだけ残っているか？という点において、フロントエンド開発の存在感が高まっています。そしてフロントエンド開発こそ、多くの企業において価値の源泉であると言えるでしょう。集客や収益化に繋がるコンテンツやプロダクト体験の根幹をなすのがフロントエンド開発だからです。
    </P>
    <P>
