...
export default withViews(({ views }) => (
  <Post>
    ...
    <P>
      そこでVercelは画期的な考えに至りました。フロントエンド開発者にとっては、プレビュー用のデプロイにアクセスできるURLに勝るものはない、と。Vercelを使えば、開発中のフロントエンドをデプロイし、すぐにプレビューURLを取得して結果を確認することができます。コンテンツ管理システム(訳者追記:
      Wordpressなど)によくあるプレビュー機能と同じですが、Vercelは
      <a href="https://vercel.com/github" target="_blank">
        <b>Gitと連携し、全てのpushに対してデプロイを行います</b>。
      </a>
      (訳者追記:
      各pushごとに独立したデプロイが行われ、毎度新しいURLが生成されます。また、ブランチごとのURLも別に生成されます)
    </P>
    <P>
